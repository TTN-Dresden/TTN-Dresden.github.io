...
* [Calliope-LoRaWAN-Lernstrecke](https://www.inf-schule.de/informatiksysteme/calliope/lernstrecke_lora/lernstrecke): es wird benötigt: 1x Calliope, 1x LoRaWAN-Modul STM32WLE5JC, 1x LoRaWAN-Gateway in der Nähe, 1x TTN-Account, Erweiterung für Maker Code / Open Roberta (Link zur Erweiterung: https://github.com/ud-edu/pxt-iot-lora-node-calliope). Info: DevEOI für den Join ist für den STM32WLE5JC fest vergeben und kann mittels QR-Code ausgelesen  werden oder beim ersten Verbinden mit dem Gateway am Gateway ausgelesen werden.
